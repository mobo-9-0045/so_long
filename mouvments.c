...
{
	if (c == 13 && var->spl[var->i - 1][var->j] == 'E')
		return (ft_exit(var));
	else if (c == 0 && var->spl[var->i][var->j - 1] == 'E')
		return (ft_exit(var));
	else if (c == 1 && var->spl[var->i + 1][var->j] == 'E')
		return (ft_exit(var));
	else if (c == 2 && var->spl[var->i][var->j + 1] == 'E')
		return (ft_exit(var));
	return (0);
}
...
int	deal(int c, t_var *var)
{
	...
	if (c == 13 && var->spl[var->i - 1][var->j] != '1')
		ft_forword(var, c);
	if (c == 0 && var->spl[var->i][var->j - 1] != '1')
		ft_left(var, c);
	if (c == 1 && var->spl[var->i + 1][var->j] != '1')
		ft_down(var, c);
	if (c == 2 && var->spl[var->i][var->j + 1] != '1')
		ft_right(var, c);
	return (0);
}
